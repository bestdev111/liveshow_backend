...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	*/
		#templateHeader{
			/*#editable*/background-color:rgba(0, 0, 0, 0.9);
											                ...
											                <table class="mcnImageContentContainer" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
											                   	<tbody><tr>
											                        <td class="mcnImageContent" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
																		...
																		<img alt="" src="{{Setting::get('site_logo')}}" style="max-width:195px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" width="195" align="middle">
            ...
            <td class="mcnTextBlockInner" style="padding-top:9px;" valign="top">
                ...
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding: 0px 18px 9px;font-size: 24px;" valign="top">
                        
                             {{tr('welcome')}} {{$email_data['name']}},
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
            ...
            <td class="mcnTextBlockInner" style="padding-top:9px;" valign="top">
                ...
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding: 0px 18px 9px;color: #FFFFFF;" valign="top">
                        
                            <p style="text-align: center !important;">{{tr('your_received_message_register_our_site')}}</p>
...
</table><table class="mcnCodeBlock" width="100%" cellspacing="0" cellpadding="0" border="0">
    <tbody class="mcnTextBlockOuter">
        <tr>
...
<div class="btn-cls">
<a href="{{url('/')}}/email/verification?id={{$email_data['data']['id']}}&verification_code={{$email_data['data']['verification_code']}}" style="color:#fff;background-color:#cf000f;border:0; padding:10px 25px;border-radius:20px;font-size:16px;text-decoration:none;">{{tr('verify_now')}}</a>
</div>
@endif
<div class="btn-cls1" @if(!Setting::get('email_verify_control')) style="text-align: center;width: 100%" @endif>
