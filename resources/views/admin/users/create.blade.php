...
@section('breadcrumb')
    ...
    <li class="active"><i class="fa fa-plus"></i> {{tr('add_user')}}</li>
@endsection
        ...
        <div class="col-md-10 ">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header label-primary">
                    <b>@yield('title')</b>
                    <a href="{{route('admin.users.index')}}" style="float:right" class="btn btn-default">
                        <i class="fa fa-eye"></i> {{tr('view_users')}}</a>
                </div>
