...
<head>
	...
	*/
        #templateBody {
            ...
            /*#editable*/
            background-image: url("https://gallery.mailchimp.com/56e7d21923a490b7f86615d02/images/d097910a-cc70-4062-bd48-0fb97319f2d2.jpg");
            /*#editable*/
            background-repeat: no-repeat;
            /*#editable*/
            background-position: center;
                                                    ...
                                                    <tr>
                                                        <td class="mcnTextBlockInner" valign="top">
                                                            <div class="mcnTextContent">
                                                                ...
                                                                <div class="btn-cls">
                                                                    <a href="{{$data['url']}}" style="text-align:center;color:#fff;background-color:#cf000f;border:0; padding:10px 25px;border-radius:20px;font-size:16px;text-decoration:none;">{{tr('reset_password')}}</a>
                                                                </div>
                                                                @endif
