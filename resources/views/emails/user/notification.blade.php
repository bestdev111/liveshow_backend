                ...
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding: 0px 18px 9px;color: #FFFFFF;" valign="top">
                            ...
                            <p style="text-align: left !important;color: #FFFFFF;">{{$email_data['streamer']}} {{tr('started_live_video')}}</p>
...
<div class="btn-cls1" style="text-align: center;width: 100%">
